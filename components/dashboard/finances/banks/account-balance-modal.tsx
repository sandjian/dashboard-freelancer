        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button
                    variant="ghost"
                    size="sm"
                    className="h-8 px-2.5 rounded-lg text-xs font-medium text-foreground hover:bg-muted border border-border/60 transition-colors shadow-2xs"
                >
            ...
            <DialogContent className="sm:max-w-md bg-card border-border text-foreground">
                <DialogHeader>
                    <DialogTitle className="text-base font-bold text-foreground">
                        Conciliar Saldo: {account.name}
                    </DialogTitle>
                </DialogHeader>
                <div className="space-y-4 py-2">
                    <p className="text-xs text-muted-foreground">
                        Ingresa el saldo real disponible en la cuenta para sincronizar de inmediato la liquidez de tu dashboard.
                    </p>
                    <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                            Nuevo Saldo ({account.currency})
                        </label>
                        <Input
                            type="number"
                            step="0.01"
