    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
            ...
            <div className="xl:col-span-8 flex flex-col bg-card rounded-xl border border-border/80 shadow-sm overflow-hidden min-h-[580px] sm:min-h-[640px]">
                ...
                {/* Responsive Grid Wrapper to prevent squishing on small mobile viewports */}
                <div className="overflow-x-auto flex-1 flex flex-col">
                    <div className="min-w-[500px] sm:min-w-0 flex-1 flex flex-col">
                        {/* Grid Header */}
                        ...
                        <div className="grid grid-cols-7 flex-1 auto-rows-fr bg-card">
                            {emptySlots.map((_, i) => (
                                <div key={`empty-${i}`} className="min-h-[80px] sm:min-h-[96px] border-b border-r border-border/50 bg-muted/5" />
                            ))}
